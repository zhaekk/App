...
public class MessageAdapter_repo extends RecyclerView.Adapter<MessageAdapter_repo.MyViewHolder>{

    List<Message_repo> messageList;
    public MessageAdapter_repo(List<Message_repo> messageList) {
